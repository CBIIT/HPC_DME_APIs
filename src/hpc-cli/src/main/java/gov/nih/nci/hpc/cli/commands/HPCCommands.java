...
//	private HPCCmdRegisterLocalFile getLocalDatafiles;
	...
	*/
	...
	public String registerFilePathS3(
			...
			@CliOption(key = {
					"replaceModifiedFiles" }, mandatory = false, help = "Do you want to replace modified files <true|false>. Usage: registerFromFilePath --sourceFilePath <Souce file path> --sourceFileList <Source files list> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationArchivePath <Destination base path> --archiveType<S3|POSIX> --dryRun <true|false>  --confirm <true|false> --checksum <true|false> --metadataOnly <true|false> --extractMetadata <true|false> --threads <number> --replaceModifiedFiles <true|false>") final String replaceModifiedFiles
			) {
		...
		criteriaMap.put("replaceModifiedFiles", replaceModifiedFiles);
