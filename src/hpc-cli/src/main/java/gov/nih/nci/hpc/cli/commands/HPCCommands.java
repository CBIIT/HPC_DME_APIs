...
public class HPCCommands implements CommandMarker {
	...
	public String registerFilePath(
			@CliOption(key = {
					"filePath" }, mandatory = true, help = "Please provide source file path. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String filePath,
			@CliOption(key = {
					"excludePatternFile" }, mandatory = false, help = "Please provide exclude pattern file. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String excludePattern,
			@CliOption(key = {
					"includePatternFile" }, mandatory = false, help = "Please provide include pattern file. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String includePattern,
			@CliOption(key = {
					"filePathBaseName" }, mandatory = false, help = "Please provide file base path name. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String filePathBaseName,
			@CliOption(key = {
					"destinationBasePath" }, mandatory = true, help = "Please provide destination base path. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String destinationBasePath,
			@CliOption(key = {
			"test" }, mandatory = false, help = "Test run to see the include and exclude files. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String test,
			@CliOption(key = {
			"metadata" }, mandatory = false, help = "Update metadata only. Usage: registerFromFilePath --filePath <Souce file path> --excludePatternFile <Patterns to exclude files> --includePatternFile <Patterns to include files> --filePathBaseName <Source file path Base name> --destinationBasePath <Destination base path> --test <true|false> --metadata <true|false>") final String metadata
			) {
		Map<String, String> criteriaMap = new HashMap<String, String>();
