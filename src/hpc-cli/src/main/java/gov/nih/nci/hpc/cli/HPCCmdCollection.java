...
public class HPCCmdCollection extends HPCCmdClient {
  ...
  private static final String FILE_NAME_PREFIX_ERROR_LOG = "getCollections_errorLog";
  private static final String FILE_NAME_PREFIX_RECORDS_LOG = "getCollections_Records";
  ...
  private static String generateErrorLogFileName() {
    ...
    sb.append(FILE_NAME_PREFIX_ERROR_LOG);
  ...
  private static String generateRecordsLogFileName(String argFileType) {
    final StringBuilder sb = new StringBuilder();
    sb.append(FILE_NAME_PREFIX_RECORDS_LOG);
    sb.append(generateDateTimeStampString());
    sb.append(RecordLogFileType.lookupFileExtensionOfFileType(argFileType));
    return sb.toString();
  }
