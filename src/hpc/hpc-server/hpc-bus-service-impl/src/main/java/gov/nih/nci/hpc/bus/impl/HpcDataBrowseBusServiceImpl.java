...
{  
    		               ...
    		               throws HpcException
    {
    	...
    	if(dataBrowseService.getBookmark(nciUserId, bookmarkName) != null) {
    	   throw new HpcException("Bookmark name already exists: " + bookmarkName, 
	                              HpcErrorType.INVALID_REQUEST_INPUT);	
    	}
    		                  ...
    		                  throws HpcException
    {
    	...
    	if(bookmark == null) {
    	   throw new HpcException("Bookmark name doesn't exist: " + bookmarkName, 
	                              HpcErrorType.INVALID_REQUEST_INPUT);	
    	}
    ...
    public void deleteBookmark(String bookmarkName) throws HpcException
    {
    	...
    	if(StringUtils.isEmpty(bookmarkName))  {
    	   throw new HpcException("Null or empty bookmark name", 
    			                  HpcErrorType.INVALID_REQUEST_INPUT);	
    	}
    	
    	// Delete the query.
    	dataBrowseService.deleteBookmark(securityService.getRequestInvoker().getNciAccount().getUserId(), 
    			                         bookmarkName);
    }
    ...
    public HpcBookmarkListDTO getBookmarks() throws HpcException
    {
    	...
    	bookmarkList.getBookmarks().addAll(
