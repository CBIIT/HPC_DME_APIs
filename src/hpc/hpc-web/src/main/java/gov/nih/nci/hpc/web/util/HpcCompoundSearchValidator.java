...
public class HpcCompoundSearchValidator {
	...
	public HpcCompoundSearchValidator(Map<String, HpcMetadataQuery> queries, String compoundQuery) throws HpcWebException
	{
	...
	{
		if(compoundQuery.indexOf(HpcCompoundQuery.CONDITION_AND) == -1 && compoundQuery.indexOf(HpcCompoundQuery.CONDITION_OR) == -1)
