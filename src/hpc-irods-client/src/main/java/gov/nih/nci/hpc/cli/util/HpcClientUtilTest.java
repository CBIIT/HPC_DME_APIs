...
public class HpcClientUtilTest {
	...
	public static WebClient getWebClient(String url, String proxyURL, String proxyPort, String hpcCertPath, String hpcCertPassword) {
	...
	{
		System.out.println("Trying with WebClient");
		WebClient client = getWebClient(args[0], args[1], args[2]);
		client.header("Authorization", "Bearer TEST");
		Response response = client.get();
		System.out.println(response.getStatus());
		System.out.println("Trying with RestTemplate");
		RestTemplate template = getRestTemplate(args[1], args[2]);
		template.getForEntity(args[0], String.class);
	}
}
