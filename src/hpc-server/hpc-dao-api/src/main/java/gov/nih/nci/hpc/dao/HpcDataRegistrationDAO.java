...
{    
    /**
     * Store a new bulk data object registration task (if dataObjectListRegistrationTask.getId() is provided NULL), 
     ...
     *
     * @param dataObjectListRegistrationTask The data object registration task to persist.
    ...
    /**
     * Get bulk data object registration tasks. 
     *
