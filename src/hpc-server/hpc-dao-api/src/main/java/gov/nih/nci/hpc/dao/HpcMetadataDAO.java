...
public interface HpcMetadataDAO {
	...
	/**
	 * Get detailed collection Paths by compound metadata query. Only collection
	...
	/**
	 * Get count of collections matching a compound metadata query. Only collections
	 * accessible to the user are included in the count.
	 *
	 * @param compoundMetadataQuery  The compound metadata query.
	 * @param dataManagementUsername The Data Management user name.
	 * @param defaultLevelFilter     A default level filter to use if not provided
	...
	/**
	 * Get detailed parent collection and attributes of data objects searched by
	 ...
	 * the user are included in the count.
	 *
	 * @param path                   The path
	 * @param dataManagementUsername The Data Management user name.
	 * @return Count of data objects matching the count.
	 ...
	 * @return The date the last metadata update was done on the collection or
	 *         data-object
	 * @throws HpcException on database error.
	 */
