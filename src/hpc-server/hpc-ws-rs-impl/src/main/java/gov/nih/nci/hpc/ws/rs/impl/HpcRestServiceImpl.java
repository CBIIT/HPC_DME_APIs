...
public abstract class HpcRestServiceImpl {
  ...
  @Autowired private HpcAPIVersionInterceptor apiVersion = null;
   ...
   *
   * @param entity The entity to attach to the response.
   * @param nullEntityAsNoContent If set to 'true', and entity is null - a 'not found' (HTTP 204)
   *     will be returned.
   * @return The REST response object.
   */
  ...
  /**
   * Return an error REST response instance. Map HpcException to the appropriate HTTP code.
   *
