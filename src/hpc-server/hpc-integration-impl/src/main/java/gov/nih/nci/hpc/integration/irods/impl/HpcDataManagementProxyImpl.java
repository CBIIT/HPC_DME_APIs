...
public class HpcDataManagementProxyImpl implements HpcDataManagementProxy {
  ...
  @Autowired private HpcIRODSConnection irodsConnection = null;
  ...
  public void createCollectionDirectory(Object authenticatedToken, String path)
    ...
    try {
      ...
      throw new HpcException(
          "Failed to create a collection directory: " + e.getMessage(),
  ...
  public void createDataObjectFile(Object authenticatedToken, String path) throws HpcException {
    ...
    try {
      ...
      throw new HpcException(
          "Failed to create a file: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
  ...
  public void addMetadataToCollection(
    ...
    try {
      for (HpcMetadataEntry metadataEntry : metadataEntries) {
        avuDatas.add(
            AvuData.instance(
                metadataEntry.getAttribute(), metadataEntry.getValue(), metadataEntry.getUnit()));
      }
      ...
      throw new HpcException(
          "Failed to add metadata to a collection: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void updateCollectionMetadata(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to update collection metadata: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void addMetadataToDataObject(
    ...
    try {
      ...
      if (!avuDatas.isEmpty()) {
        irodsConnection
            .getDataObjectAO(authenticatedToken)
            .addBulkAVUMetadataToDataObject(getAbsolutePath(path), avuDatas);
      }

    } catch (DuplicateDataException dde) {
      throw new HpcException(
          "Failed to add metadata to a data object: " + dde.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          dde);
    } catch (JargonException e) {
      throw new HpcException(
          "Failed to add metadata to a data object: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void updateDataObjectMetadata(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to update data object metadata: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public HpcCollection getCollection(Object authenticatedToken, String path, boolean list)
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get Collection: " + path + ". " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public HpcDataObject getDataObject(Object authenticatedToken, String path) throws HpcException {
    try {
      ...
      throw new HpcException(
          "Failed to get Data Object: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public List<HpcDataObject> getDataObjects(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get data objects: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public void addUser(Object authenticatedToken, HpcNciAccount nciAccount, HpcUserRole userRole)
    ...
    try {
      ...
      throw new HpcException(
          "iRODS account already exists: " + nciAccount.getUserId(),
          HpcRequestRejectReason.USER_ALREADY_EXISTS,
          ex);

    } catch (Exception e) {
      throw new HpcException(
          "Failed add iRODS user: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void deleteUser(Object authenticatedToken, String nciUserId) throws HpcException {
    ...
    try {
      ...
      throw new HpcException(
          "Failed delete iRODS user: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void updateUser(
    ...
    if (irodsUser == null) {
      throw new HpcException(
          "iRODS account does not exist: " + username,
    ...
    try {
      ...
      throw new HpcException(
          "Failed to update iRODS user: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public List<HpcSubjectPermission> getCollectionPermissions(Object authenticatedToken, String path)
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get collection permissions: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public HpcSubjectPermission getCollectionPermission(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get collection permission for user: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public HpcSubjectPermission acquireCollectionPermission(
    ...
    try {
      ...
      String msg =
          String.format(
              "Failed to acquire collection permission for user [%s]: %s", userId, e.getMessage());
  ...
  public void setCollectionPermission(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to set collection permission: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public List<HpcSubjectPermission> getDataObjectPermissions(Object authenticatedToken, String path)
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get data object permissions: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public HpcSubjectPermission getDataObjectPermission(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get data object permission for user: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  public void setDataObjectPermission(
    ...
    try {
      ...
      throw new HpcException(
          "Failed to set data object permission: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void addGroup(Object authenticatedToken, String groupName) throws HpcException {
    try {
      ...
      throw new HpcException(
          "Failed to add a group: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void deleteGroup(Object authenticatedToken, String groupName) throws HpcException {
    try {
      ...
      throw new HpcException(
          "Failed to delete a group: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public boolean groupExists(Object authenticatedToken, String groupName) throws HpcException {
    try {
      String where =
          RodsGenQueryEnum.COL_USER_GROUP_NAME.getName()
              + " = '"
              + groupName
              + "' and "
      ...
      throw new HpcException(
          "Failed to get a group: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  public void addGroupMember(Object authenticatedToken, String groupName, String userId)
    ...
    try {
      irodsConnection
          .getUserGroupAO(authenticatedToken)
          .addUserToGroup(groupName, userId, irodsConnection.getZone());

    } catch (InvalidGroupException ige) {
      throw new HpcException(
          "Failed to add group member. Invalid group: " + groupName,
          HpcErrorType.INVALID_REQUEST_INPUT,
          ige);

    } catch (InvalidUserException iue) {
      throw new HpcException(
          "Failed to add group member. Invalid user: " + userId,
          HpcErrorType.INVALID_REQUEST_INPUT,
          iue);
  ...
  public void deleteGroupMember(Object authenticatedToken, String groupName, String userId)
    ...
    try {
      irodsConnection
          .getUserGroupAO(authenticatedToken)
          .removeUserFromGroup(groupName, userId, irodsConnection.getZone());

    } catch (InvalidGroupException ige) {
      throw new HpcException(
          "Failed to delete group member. Invalid group: " + groupName,
          HpcErrorType.INVALID_REQUEST_INPUT,
          ige);

    } catch (InvalidUserException iue) {
      throw new HpcException(
          "Failed to delete group member. Invalid user: " + userId,
          HpcErrorType.INVALID_REQUEST_INPUT,
          iue);

    } catch (Exception e) {
      throw new HpcException(
          "Failed to delete group member: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
  ...
  private void mkdirs(IRODSFile irodsFile) throws HpcException {
    ...
    try {
      ...
      throw new HpcException(
          "Failed to create directory: " + getRelativePath(irodsFile.getPath()),
          HpcErrorType.INVALID_REQUEST_INPUT,
          HpcIntegratedSystem.IRODS,
          e);
    }
      ...
      for (HpcMetadataQuery metadataQuery : metadataQueries) {
        ...
        queryElements.add(
            AVUQueryElement.instanceForValueQuery(
                AVUQueryPart.ATTRIBUTE, operator, metadataQuery.getAttribute()));
        queryElements.add(
            AVUQueryElement.instanceForValueQuery(
                AVUQueryPart.VALUE, operator, metadataQuery.getValue()));
      }

    } catch (JargonQueryException e) {
      throw new HpcException(
          "Failed to get prepare iRODS query: " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
   ...
   * @return A collection.
   */
  private HpcCollection toHpcCollection(
      Collection irodsCollection, List<CollectionAndDataObjectListingEntry> listingEntries) {
    ...
    hpcCollection.setCollectionParentName(
        getRelativePath(irodsCollection.getCollectionParentName()));
  ...
  private User getUser(Object authenticatedToken, String username) throws HpcException {
    try {
      ...
      throw new HpcException(
          "Failed to get user: " + username + ". " + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          null,
          e);
    }
  ...
  private IRODSFile getParentPath(Object authenticatedToken, String path) throws HpcException {
    ...
    try {
      ...
      throw new HpcException(
          "Failed to get a parent path" + e.getMessage(),
          HpcErrorType.DATA_MANAGEMENT_ERROR,
          HpcIntegratedSystem.IRODS,
          e);
    }
   ...
   * @throws HpcException on data management system failure.
   */
  private List<HpcSubjectPermission> toHpcSubjectPermissions(
      Object authenticatedToken, List<UserFilePermission> irodsUserPermissions)
      throws HpcException {
   ...
   * @throws HpcException on data management system failure.
   */
  private HpcSubjectPermission toHpcSubjectPermission(
      Object authenticatedToken, UserFilePermission irodsUserPermission, boolean checkGroup)
      throws HpcException {
    HpcSubjectPermission hpcSubjectPermission = new HpcSubjectPermission();
    hpcSubjectPermission.setPermission(
        toHpcPermission(irodsUserPermission.getFilePermissionEnum()));
  ...
  private FilePermissionEnum toIRODSFilePermissionEnum(HpcPermission permission)
    ...
    switch (permission) {
      ...
      default:
        throw new HpcException(
            "Permission value not supported: " + permission.toString(),
