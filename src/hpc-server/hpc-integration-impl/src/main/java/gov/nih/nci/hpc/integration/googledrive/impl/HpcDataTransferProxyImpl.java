...
public class HpcDataTransferProxyImpl implements HpcDataTransferProxy {
  ...
  public HpcDataObjectUploadResponse uploadDataObject(
      ...
      throws HpcException {
	  throw new HpcException("uploadDataObject() not supported",
  ...
  public String downloadDataObject(
	  ...
	  try {
	  Drive service = new Drive.Builder(GoogleNetHttpTransport.newTrustedTransport(), JacksonFactory.getDefaultInstance(), new GoogleCredential().setAccessToken(""))
              .setApplicationName("")
              .build();
	  ...
	  service.files().create(fileMetadata, new InputStreamContent("application/octet-stream",  sourceInputStream));
	  
	  } catch(IOException | GeneralSecurityException  e) {
		  throw new HpcException(
		  "[GoogleDrive] Failed to list objects: " + e.getMessage(),
