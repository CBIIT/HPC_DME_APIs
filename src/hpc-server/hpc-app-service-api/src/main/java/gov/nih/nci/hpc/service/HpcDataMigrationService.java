...
public interface HpcDataMigrationService {
     ...
     * @param externalArchiveAutoTieringRequest                 True to indicate this is an auto-tiering
    ...
    /**
     * Create a bulk auto-tiering task.
     *
     * @param configurationId              The data management configuration ID.
     * @param fromS3ArchiveConfigurationId The auto-tiering source S3 config ID.
     * @param toS3ArchiveConfigurationId   The auto-tiering destination S3 config ID.
     * @param userId                       The user Id requested the bulk auto-tiering.
     * @return A migration task ID.
     * @throws HpcException on service failure.
     */
