...
public interface HpcDataManagementService {
	 ...
	 * @throws HpcException
	 *             on data management system failure.
	 */
	 ...
	 *            The path to delete.
	 * @param quiet
	 *            If set to true, no exception is thrown in case of a failure.
	 * @throws HpcException
	 *             on service failure (unless 'quiet' is set to 'true').
	 */
	 ...
	 *
	 * @param path
	 *            The data object or collection path.
	 * @param requestType
	 *            The request being recorded for audit.
	 * @param metadataBefore
	 *            The collection or data object metadata before the request.
	 * @param metadataAfter
	 *            (Optional) The collection or data object metadata after the
	 *            request.
	 * @param archiveLocation
	 *            (Optional) The location of the file in the archive (prior to
	 *            deletion).
	 * @param dataManagementStatus
	 *            Data management (iRODS) request completion status.
	 * @param dataTransferStatus
	 *            (Optional) Data transfer (Cleversafe) request completion status.
	 * @param message
	 ...
	 *            The subject permission request.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 *
	 * @param path
	 *            Path of given collection.
	 * @param userId
	 *            UserId of given user.
	 ...
	 *            Use validation rules of this data management configuration.
	 * @param dataObjectRegistration
	 *            If true, the service validates if data object registration is
	 ...
	 * @param list
	 *            An indicator to list sub-collections and data-objects.
	 * @return A collection.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 *
	 * @param userId
	 *            The user ID requested the registration.
	 * @param dataObjectRegistrationRequests
	 *            The data object registration requests.
	 ...
	 *            The registration task to update.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 *
	 * @param path
	 *            the path to find a config ID for.
	 ...
	 * 
	 * @param basePath
	 *            The base path to get the config for.
	 *
