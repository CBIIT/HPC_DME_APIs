...
public interface HpcMetadataService {
	 ...
	 *            The metadata entries to add.
	 * @param configurationId
	 *            The configuration to apply validation rules. Metadata validation
	 *            rules are configuration specific.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 *            The collection path.
	 * @param metadataEntries
	 *            The metadata entries to update.
	 * @param configurationId
	 *            The configuration to apply validation rules. Metadata validation
	 *            rules are configuration specific.
	 * @throws HpcException
	 ...
	 *
	 * @param systemGeneratedMetadataEntries
	 *            The system generated metadata entries.
	 * @return The system generated metadata.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 *
	 * @param scanItem
	 *            The directory scan item to generate the default metadata for.
	 ...
	 *            The collection type containing the data object.
	 * @throws HpcException
	 *             on service failure.
	 */
	public void addMetadataToDataObject(String path, List<HpcMetadataEntry> metadataEntries, String configurationId,
			String collectionType) throws HpcException;

	/**
	 * Generate system metadata and attach to the data object. System generated
	 * metadata is: 1. UUID. 2. Registrar user ID. 3. Registrar name. 4.
	 * Configuration ID. 5. Source location (file-container-id and file-id).
	 * (Optional). 6. Archive location (file-container-id and file-id). 7. Data
	 * Transfer Request ID. (Optional) 8. Data Transfer Status. 9. Data Transfer
	 * Type. 10. Data Transfer Started. 11. Data Transfer Completed (Optional). 12.
	 * Data Object File size. (Optional). 13. Caller Object ID (Optional). 14.
	 * Registration Completion Event Indicator.
	 *
	 * @param path
	 *            The data object path.
	 * @param archiveLocation
	 *            The physical file archive location.
	 * @param sourceLocation
	 *            (Optional) The source location of the file.
	 * @param dataTransferRequestId
	 *            (Optional) The data transfer request ID.
	 * @param dataTransferStatus
	 *            The data transfer upload status.
	 * @param dataTransferType
	 *            The data transfer type.
	 * @param dataTransferStarted
	 *            The time data transfer started.
	 * @param dataTransferCompleted
	 *            (Optional) The time data transfer completed.
	 * @param sourceSize
	 *            (Optional) The data source size in bytes.
	 * @param callerObjectId
	 *            (Optional) The caller object ID.
	 * @param userId
	 *            The user ID.
	 * @param userName
	 *            The user name.
	 ...
	 * @param registrationCompletionEvent
	 *            If set to true, an event will be generated when registration is
	 *            completed or failed.
	 * @return The system generated metadata.
	 * @throws HpcException
	 *             on service failure.
	...
	public HpcSystemGeneratedMetadata addSystemGeneratedMetadataToDataObject(String path,
			...
			Calendar dataTransferStarted, Calendar dataTransferCompleted, Long sourceSize, String callerObjectId,
	 ...
	 *            The data object path.
	 * @param archiveLocation
	 *            (Optional) The physical file archive location.
	 * @param dataTransferRequestId
	 *            (Optional) The data transfer request ID.
	 * @param checksum
	 *            (Optional) The data checksum.
	 * @param dataTransferStatus
	 *            (Optional) The data transfer upload status.
	 * @param dataTransferType
	 *            (Optional) The data transfer type.
	 * @param dataTransferStarted
	 *            (Optional) The time data transfer started.
	 * @param dataTransferCompleted
	 *            (Optional) The time data transfer completed.
	 * @throws HpcException
	 *             on service failure.
