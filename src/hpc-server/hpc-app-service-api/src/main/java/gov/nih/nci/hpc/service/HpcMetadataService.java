...
public interface HpcMetadataService {
	 ...
	 * @return The object-id (system generated) metadata entry. Note - the metadata
	 *         itself is not added to the object in iRODS. The actual addition of
	 *         the object-id system metadata to iRODS is done by
	 *         addSystemGeneratedMetadataToDataObject()
	 * @throws HpcException on service failure.
	 */
	 ...
	 *
	 * @param path                  The data object path.
	 * @param dataObjectInputStream The file (input stream) to extract metadata
	 *                              from.
	 ...
	 *
	 * @param path                     The data object path.
	 * @param extractedMetadataEntries The extracted metadata (from the physical
	 *                                 file) entries to add.
	 * @param configurationId          The configuration to apply validation rules.
	 *                                 Metadata validation rules are configuration
	 *                                 specific.
	 * @param collectionType           The collection type containing the data
	 *                                 object.
	 * @throws HpcException on service failure.
	 */
	 ...
	 * @param sourceLocation              (Optional) The source location of the
	 *                                    file.
	 ...
	 * @param dataTransferCompleted       (Optional) The time data transfer
	 *                                    completed.
	 ...
	 *
	 * @param path                     The data object path.
	 * @param archiveLocation          (Optional) The physical file archive
	 *                                 location.
	 * @param dataTransferRequestId    (Optional) The data transfer request ID.
	 ...
	 * @throws HpcException on service failure.
	 */
	public HpcGroupedMetadataEntries getDataObjectGroupedMetadataEntries(String path, boolean excludeParentMetadata) throws HpcException;
