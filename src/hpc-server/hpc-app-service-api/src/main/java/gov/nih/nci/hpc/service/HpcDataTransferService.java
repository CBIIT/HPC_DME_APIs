...
public interface HpcDataTransferService {
	...
	public HpcDataObjectDownloadResponse downloadDataObject(String path, HpcFileLocation archiveLocation,
			...
			HpcDataTransferUploadStatus downloadDataObject, HpcDeepArchiveStatus deepArchiveStatus, boolean externalArchive) throws HpcException;
	...
	/**
	 * Get all data object download task results associated with the given collection
	 * download task.
	 *
	 * @param taskId The collection download task Id
	 * @return A list of data object download task results.
	 * @throws HpcException on service failure.
	 */
