...
public interface HpcDataTransferService {
	 ...
	 * @param configurationId  The configuration ID (needed to determine the archive
	 *                         connection config).
	 * @param objectId         The data object id from the data management system
	 *                         (UUID).
	 ...
	 *
	 * @param dataTransferType  The data transfer type.
	 * @param s3Account         (Optional) S3 account to use. If null, then system
	 *                          account for the data transfer type is used.
	 * @param directoryLocation The endpoint/directory to scan and get a list of
	 *                          files for.
	 * @param configurationId   The configuration ID (needed to determine the
	 *                          archive connection config).
	 * @param includePatterns   The patterns to use to include files in the scan
	 *                          results.
	 * @param excludePatterns   The patterns to use to exclude files from the scan
	 *                          results.
