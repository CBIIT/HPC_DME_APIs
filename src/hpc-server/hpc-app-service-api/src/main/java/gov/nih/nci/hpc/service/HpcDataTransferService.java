...
public interface HpcDataTransferService {
	/**
	 * Upload data. Either upload from the input stream or submit a transfer request
	 * for the source.
	 * 
	 * @param sourceLocation
	 *            The source for data transfer.
	 * @param sourceFile
	 *            The source file.
	 * @param generateUploadRequestURL
	 *            Generate an upload URL (so caller can directly upload file into
	 *            archive).
	 * @param path
	 *            The data object registration path.
	 * @param userId
	 *            The user-id who requested the data upload.
	 * @param callerObjectId
	 *            The caller's provided data object ID.
	 ...
	 *            The user requested file destination.
	 ...
	 *            config).
	 * @param userId
	 *            The user ID submitting the download request.
	...
	public HpcDataTransferUploadReport getDataTransferUploadStatus(HpcDataTransferType dataTransferType,
			String dataTransferRequestId, String configurationId) throws HpcException;
	 ...
	 *            The data transfer type.
	 * @param fileLocation
	 *            The endpoint/path to get attributes for.
	 * @param getSize
	 ...
	 *            The endpoint/directory to scan and get a list of files for.
	 * @param configurationId
	 *            The configuration ID (needed to determine the archive connection
	 *            config).
	 * @param includePatterns
	 *            The patterns to use to include files in the scan results.
	 * @param excludePatterns
	 *            The patterns to use to exclude files from the scan results.
	 * @param patternType
	 *            The type of the patterns provided.
	 ...
	 *
	 * @param dataTransferType
	 *            The data-transfer type to query.
	 ...
	 * @param taskType
	 *            The download task type (data-object or collection).
	...
	/**
	 * Complete a data object download task: 1. Cleanup any files staged in the file
	 * system for download. 2. Update task info in DB with results info.
	 *
	 * @param downloadTask
	 ...
	 * @param completed
	 *            (Optional) The download task completion timestamp.
	 * @throws HpcException
	 *             on service failure.
	 */
	...
	/**
	 * Continue a data object download task that was queued. Note: If Globus is
	 * still busy, the download task will remain queued.
	 * 
	 * @param downloadTask
	 *            The download task to submit to Globus.
	 * @throws HpcException
	 *             on service failure.
	 */
	 ...
	 * 
	 * @param dataObjectPathsMap
	 *            A map of data-object-path to its configuration ID.
	 * @param destinationLocation
	 *            The user requested destination.
	 * @param userId
	 *            The user ID submitting the download request.
	 ...
	 * 
	 * @param downloadTask
	 *            The collection download task to update.
	 * @throws HpcException
	 *             on service failure.
	 */
