...
public interface HpcDataTransferProxy {
	 ...
	 */
	public default Object authenticate(HpcIntegratedSystemAccount dataTransferAccount, String url) throws HpcException {
	...
	public HpcDataObjectUploadResponse uploadDataObject(Object authenticatedToken,
			...
			Integer uploadRequestURLExpiration, HpcDataTransferProgressListener progressListener) throws HpcException;
	...
	public default String copyDataObject(Object authenticatedToken, HpcFileLocation sourceFile,
			HpcFileLocation destinationFile, HpcArchive baseArchiveDestination, List<HpcMetadataEntry> metadataEntries)
			throws HpcException {
