...
public interface HpcDataManagementProxy {
	 ...
	 *         management. It returns null if the account is not authenticated.
	 ...
	 * @param authenticatedToken   An authenticated token.
	 * @param path                 The collection path.
	 * @param permissionInheritace If true, any collections / data objects created
	 *                             under this collection will inherit the same
	 *                             permissions as this collection.
	 * @throws HpcException on data management system failure.
	 */
	 ...
	 * @param list               An indicator to list sub-collections and
	 *                           data-objects.
	 * @param linkSourcePath     (Optional) A source path this collection is linked
	 *                           to.
	 ...
	 *
	 * @param authenticatedToken An authenticated token.
	 * @param nciAccount         The NCI account of the user to be added to data
	 *                           management.
	 ...
	 * @param authenticatedToken An authenticated token.
	 * @param path               The collection's path.
	 * @return A list of subjects (users/groups) and their permission on the
	 *         collection.
	 * @throws HpcException on data management system failure.
	 */
	 ...
	 *
	 * <p>
	 * Similar to <code>getCollectionPermission</code> method of this class but
	 * internally ensures that no permission is represented as a level of "NONE"
	...
	/**
	 * Acquire permissions of the given user on the direct children of the given
	 * parent collection.
	 *
	 * @param authenticatedToken An authenticated token.
	 * @param parentPath         Path of the parent collection. If null or blank,
	 *                           the base path of the irods connection will be used
	 *                           as the parent.
	 * @param userId             UserId of given user.
	 * @return <code>List<HpcPermissionForCollection></code> List of collection
	 ...
	 *
	 * <p>
	 * Similar to <code>getDataObjectPermission</code> method of this class but
	 * internally ensures that no permission is represented as a level of "NONE"
	 * even if iRODS Jargon API returns null to indicate no permission.
	 *
	 * @param authenticatedToken An authenticated token.
	 ...
	 * @param userId             UserId of given user.
	 * @return <code>HpcSubjectPermission</code> instance representing given user's
	 *         permission on given DataObject
	 * @throws HpcException on data management system failure.
	 */
	 ...
	 * @param authenticatedToken An authenticated token.
	 * @param path               The collection's path.
	 * @param permissionRequest  The permission request for a subject (user or
	 *                           group).
	 * @throws HpcException on data management system failure.
	 */
	 ...
	 * @return A list of subjects (users/groups) and their permission on the data
	 *         object.
	 * @throws HpcException on data management system failure.
	 */
