...
public class HpcStreamingDownload implements HpcDataTransferProgressListener {
	...
	private void updateDownloadTask(HpcDataObjectDownloadTask downloadTask) throws HpcException {
		...
		// Updating the internal downloadTask structure with the externalArchiveFlag which is set during the createDownloadTask(therefore it does not to be updated in the DB in the previous step).
