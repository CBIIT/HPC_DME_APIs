...
public class HpcDataManagementServiceImpl implements HpcDataManagementService {
	 ...
	 * 
	 * @param systemAdminSubjects
	 *            The system admin subjects (which update permissions not allowed
	 *            for).
	 */
	...
	public List<HpcBulkDataObjectRegistrationResult> getRegistrationResults(String userId, int page)
			throws HpcException {
		return dataRegistrationDAO.getBulkDataObjectRegistrationResults(userId, pagination.getOffset(page), pagination.getPageSize());
	}
	 ...
	 * @throws HpcException
	 *             If the request is to change permission of a system account
	 */
