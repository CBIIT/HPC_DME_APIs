...
public class HpcDataTransferServiceImplTest {
	...
	public void testDownloadDataObjectNullDataTransferType() throws HpcException {
		...
		dataTransferService.downloadDataObject("", null, null, null, null, null, null, null, "", null, "", null, "", false, null,
	...
	public void testDownloadDataObjectInvalidArchiveLocation() throws HpcException {
		...
		dataTransferService.downloadDataObject("", new HpcFileLocation(), null, null, null, null, null,
				HpcDataTransferType.S_3, "", null, "", null, "", false, null, 0L, HpcDataTransferUploadStatus.ARCHIVED, null);
	}
