...
public interface HpcDataManagementRestService {
  ...
  public Response interrogatePathRef(@PathParam("path") String path);
	 ...
	 *            A DTO contains the list of metadata entries to attach to the
	 *            collection.
	 * @return The REST service response.
	 */
	@PUT
	 ...
	 * @param path
	 *            The collection path.
	 * @param collectionPermissionsRequest
	 *            Request to set collection permissions.
	 ...
	 *            A DTO contains the metadata and data transfer locations.
	 * @param dataObjectInputStream
	 *            The data object input stream.
	 * @return The REST service response.
	 */
	@PUT
	 ...
	 *
	 * @param bulkDataObjectRegistrationRequest
	 ...
	 * @param totalCount
	 *            If set to true, return the total count of completed tasks. All
	 *            active tasks are always returned.
	 ...
	 * @param path
	 *            The data object path.
	 * @param dataObjectPermissionsRequest
	 *            Request to set data object permissions.
	 * @return The REST service response w/ HpcEntityPermissionsResponseDTO entity.
	 */
	@POST
	 ...
	 *            The data object path.
	 * @param userId
	 *            The userId to get the permission for.
	 * @return The REST service response w/ HpcUserPermissionDTO entity.
	 */
	@GET
