...
public interface HpcDataManagementRestService {
   ...
   * @param collectionRegistration A DTO contains the list of metadata entries to attach to the
   *     collection.
   * @return The REST service response.
   */
  @PUT
  ...
  public Response registerCollection(
      @PathParam("path") String path, HpcCollectionRegistrationDTO collectionRegistration);
  ...
  public Response setCollectionPermissions(
      @PathParam("path") String path, HpcEntityPermissionsDTO collectionPermissionsRequest);
  ...
  @Produces("application/json; charset=UTF-8, application/xml; charset=UTF-8")
  public Response getCollectionPermission(
      @PathParam("path") String path, @PathParam("userId") String userId);
  ...
  public Response getPermissionsOnCollectionsForUser(
      @QueryParam("collectionPath") String[] collectionsPaths, @PathParam("userId") String userId);
  ...
  @Path("/collection/acl")
  @Produces("application/json; charset=UTF-8, application/xml; charset=UTF-8")
  public Response getAllPermissionsOnCollections(
      @QueryParam("collectionPath") String[] collectionPaths);
  ...
  public Response setDataObjectPermissions(
      @PathParam("path") String path, HpcEntityPermissionsDTO dataObjectPermissionsRequest);
  ...
  @Produces("application/json; charset=UTF-8, application/xml; charset=UTF-8")
  public Response getDataObjectPermission(
      @PathParam("path") String path, @PathParam("userId") String userId);
