...
public interface HpcDataManagementRestService {
   ...
   *
   * <p>
   * The userId is embedded in the URI, but the collections' paths are expected to be received as
  ...
  public Response registerDataObject(@PathParam("path") String path,
      @Multipart(value = "dataObjectRegistration",
          type = "application/json") HpcDataObjectRegistrationRequestDTO dataObjectRegistration,
  ...
  @Consumes("multipart/form-data")
  @Produces("application/json; charset=UTF-8, application/xml; charset=UTF-8")
  public Response registerDataObject(@PathParam("path") String path, @Multipart(
      value = "dataObjectRegistration",
  ...
  public Response downloadDataObject(@PathParam("path") String path,
      HpcDownloadRequestDTO downloadRequest, @Context MessageContext mc);
