...
insert into "HPC_CATALOG_ATTRIBUTE" values ('PI_Lab','pi_name');
insert into "HPC_CATALOG_ATTRIBUTE" values ('PI_Lab','affiliation');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','origin');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','project_title');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','project_description');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','method');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','start_date');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','access');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','project_affiliation');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','project_poc');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','publication_status');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','origin_repository');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','origin_accession_id');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','study_id');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','study_design');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','study_disease');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','assembly_name');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','cell_line_name');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','number_of_cases');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','summary_of_samples');
insert into "HPC_CATALOG_ATTRIBUTE" values ('Project','organism');
