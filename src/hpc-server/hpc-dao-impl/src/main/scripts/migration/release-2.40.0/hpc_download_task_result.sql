...
COMMENT ON COLUMN HPC_ARCHIVE_TASK_RESULT.ARCHIVE_LOCATION_FILE_CONTAINER_ID IS 'The bucket containing the data object';

ALTER TABLE HPC_DOWNLOAD_TASK_RESULT add (ARCHIVE_LOCATION_FILE_ID VARCHAR2(2700));
COMMENT ON COLUMN HPC_DOWNLOAD_TASK_RESULT.ARCHIVE_LOCATION_FILE_ID IS 'The key or path of the data object';
