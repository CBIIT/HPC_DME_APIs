...
ALTER TABLE HPC_COLLECTION_DOWNLOAD_TASK add (ASPERA_ACCOUNT_USER BLOB);
COMMENT ON COLUMN HPC_COLLECTION_DOWNLOAD_TASK.ASPERA_ACCOUNT_USER IS
                 'The Aspera account user';
                 
ALTER TABLE HPC_COLLECTION_DOWNLOAD_TASK add (ASPERA_ACCOUNT_PASSWORD BLOB);
COMMENT ON COLUMN HPC_COLLECTION_DOWNLOAD_TASK.ASPERA_ACCOUNT_PASSWORD IS
                 'The Aspera account password';

ALTER TABLE HPC_COLLECTION_DOWNLOAD_TASK add (ASPERA_ACCOUNT_HOST VARCHAR2(250));
COMMENT ON COLUMN HPC_COLLECTION_DOWNLOAD_TASK.ASPERA_ACCOUNT_HOST IS
                 'The Aspera account host';