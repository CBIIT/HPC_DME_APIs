...
ALTER TABLE HPC_DATA_MIGRATION_TASK add (METADATA_ARCHIVE_FILE_CONTAINER_ID VARCHAR2(2700));
...
ALTER TABLE HPC_DATA_MIGRATION_TASK add (METADATA_ARCHIVE_FILE_ID_PATTERN VARCHAR2(50));
...
ALTER TABLE HPC_DATA_MIGRATION_TASK_RESULT add (METADATA_ARCHIVE_FILE_CONTAINER_ID VARCHAR2(2700));
COMMENT ON COLUMN HPC_DATA_MIGRATION_TASK_RESULT.METADATA_ARCHIVE_FILE_CONTAINER_ID IS
                 'The file container id (bucket) targeted for metadata migration';
                 
ALTER TABLE HPC_DATA_MIGRATION_TASK_RESULT add (METADATA_ARCHIVE_FILE_ID_PATTERN VARCHAR2(50));
