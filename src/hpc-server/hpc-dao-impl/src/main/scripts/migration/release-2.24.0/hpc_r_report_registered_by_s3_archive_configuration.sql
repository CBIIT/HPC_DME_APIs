...
create materialized view R_REPORT_REGISTERED_BY_S3_ARCHIVE_CONFIGURATION (S3_ARCHIVE_PROVIDER, S3_ARCHIVE_STORAGE_CLASS, S3_ARCHIVE_BUCKET, S3_ARCHIVE_CONFIGURATION_ID, OBJECT_ID)
...
GROUP BY d."PROVIDER", d."STORAGE_CLASS", d."BUCKET", d."OBJECT_ID",
         a.meta_attr_name,
         a.meta_attr_value,
         b.object_id,
         b.meta_id,
