...
ALTER TABLE HPC_DOWNLOAD_TASK_RESULT add (RETRY_TASK_ID VARCHAR2(250)); 
COMMENT ON COLUMN HPC_DOWNLOAD_TASK_RESULT.RETRY_TASK_ID IS 'A task ID to be re-tried';  