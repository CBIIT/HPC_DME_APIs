...
ALTER TABLE HPC_COLLECTION_DOWNLOAD_TASK add (DATA_TRANSFER_REQUEST_ID VARCHAR2(50)); 
COMMENT ON COLUMN HPC_COLLECTION_DOWNLOAD_TASK.DATA_TRANSFER_REQUEST_ID IS 'Data transfer (Globus task) request ID';  
