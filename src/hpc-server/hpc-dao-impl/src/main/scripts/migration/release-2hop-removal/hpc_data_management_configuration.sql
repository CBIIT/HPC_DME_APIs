...
-- The value of this variable needs to be updated per the environment this script is run against.
SET CLEVERSAFE_VAULT_ENDPOINT.var =  'd9330dbe-8dd1-11e9-b808-0a37f382de32';
...
UPDATE public."HPC_DATA_MANAGEMENT_CONFIGURATION" SET "ARCHIVE_GLOBUS_ENDPOINT"= current_setting('CLEVERSAFE_VAULT_ENDPOINT.var') WHERE "GLOBUS_ARCHIVE_TYPE" = 'TEMPORARY_ARCHIVE';
...
UPDATE public."HPC_DATA_MANAGEMENT_CONFIGURATION" SET "ARCHIVE_GLOBUS_PATH"= CONCAT('/', "ARCHIVE_S3_OBJECT_ID") WHERE "GLOBUS_ARCHIVE_TYPE" = 'TEMPORARY_ARCHIVE';
...
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_URL";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_ARCHIVE_ENDPOINT";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_ARCHIVE_PATH";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_ARCHIVE_DIRECTORY";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_ARCHIVE_TYPE";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_DOWNLOAD_ENDPOINT";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_DOWNLOAD_PATH";
ALTER TABLE public."HPC_DATA_MANAGEMENT_CONFIGURATION" DROP COLUMN "GLOBUS_DOWNLOAD_DIRECTORY";
