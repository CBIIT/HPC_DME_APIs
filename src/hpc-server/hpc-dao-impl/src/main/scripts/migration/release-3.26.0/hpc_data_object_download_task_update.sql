...
ALTER TABLE HPC_DOWNLOAD_TASK_RESULT add (
    EXTERNAL_ARCHIVE_FLAG CHAR default '0'
	);
COMMENT ON COLUMN HPC_DOWNLOAD_TASK_RESULT.EXTERNAL_ARCHIVE_FLAG IS 'Indicates if the data is stored externally';
