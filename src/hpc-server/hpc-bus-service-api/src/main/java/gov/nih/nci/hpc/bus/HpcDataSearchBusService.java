...
public interface HpcDataSearchBusService {
	 ...
	 * @param pageSize         (Optional) The page size specified by the user. If
	 *                         not specified, it will take the default.
	 * @param totalCount       If set to true, return the total count of collections
	 *                         matching the query regardless of the limit on
	 *                         returned entities.
	 * @return A list of Collection DTO.
	 * @throws HpcException on service failure.
	 */
	 ...
	 * @param page       The requested results page.
	 * @param pageSize   (Optional) The page size specified by the user. If not
	 *                   specified, it will take the default.
	 * @param totalCount If set to true, return the total count of collections
	 *                   matching the query regardless of the limit on returned
	 *                   entities.
	 * @return A list of Data Object DTO.
	 * @throws HpcException on service failure.
	 */
	...
	/**
	 * Get parent collections of the data objects searched by compound metadata
	 * query.
	 *
	 * @param compoundMetadataQueryDTO The compound metadata query DTO.
	 * @return A list of Data Object DTO.
	 ...
	 * @throws HpcException on service failure.
	 */
	public void updateQuery(String queryName, HpcCompoundMetadataQueryDTO compoundMetadataQueryDTO) throws HpcException;
