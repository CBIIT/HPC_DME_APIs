...
/**
 * <p>
 * Controller to get list of running tasks for the user. This list is displayed
 * on Task board
 * </p>
 *
...
@RequestMapping("/downloadTasksList")
public class HpcDownloadTasksListController extends AbstractHpcController {
	...
	public List<HpcTask> get(@Valid @ModelAttribute("hpcSaveSearch") HpcSaveSearch search, Model model,
		...
		try {
			HpcDownloadSummaryDTO downloads = HpcClientUtil.getDownloadSummary(authToken, queryServiceURL, sslCertPath,
					sslCertPassword);
